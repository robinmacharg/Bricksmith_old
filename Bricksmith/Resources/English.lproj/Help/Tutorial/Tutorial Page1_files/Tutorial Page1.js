...
{
    detectBrowser();
    fixupIEPNG("id1", "Tutorial Page1_files/transparent.gif");
    fixupIEPNG("id2", "Tutorial Page1_files/transparent.gif");
    fixupIEPNG("id3", "Tutorial Page1_files/transparent.gif");
    fixupIEPNG("id4", "Tutorial Page1_files/transparent.gif");
    fixupIEPNG("id5", "Tutorial Page1_files/transparent.gif");
    fixupIEPNG("id6", "Tutorial Page1_files/transparent.gif");
    fixupIEPNG("id7", "Tutorial Page1_files/transparent.gif");
    fixupIEPNG("id8", "Tutorial Page1_files/transparent.gif");
    fixupIEPNG("id9", "Tutorial Page1_files/transparent.gif");
    fixupIEPNG("id10", "Tutorial Page1_files/transparent.gif");
