...
//				more with it.
//
//				By default, the range is 0.0 to 100.0 and it does not show 
//				time remaining, and does not become indeteriminate upon 
//				completion.
//
//==============================================================================
...
//
//==============================================================================
+ (AMSProgressPanel*) doProgressBarWithMax:(float)maximum
...
- (void) setValue:(float)newValue{
	float maximumToAttain = [progressBar maxValue];
	...
	if(newValue < maximumToAttain){
		...
		if(-[previousUpdateTime timeIntervalSinceNow] > timeBetweenUpdates)
		{
			...
			NSString		*unitsForTimeRemaining;
			int				 numberUnitsRemaining;
